        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskStatusStatusId = table.Column<byte>(type: "tinyint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskItems_TaskStatuses_TaskStatusStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_TaskStatusStatusId",
                table: "TaskItems",
                column: "TaskStatusStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskStatuses_StatusName",
                table: "TaskStatuses",
                column: "StatusName",
                unique: true);
